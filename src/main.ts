...
async function bootstrap() {
  ...
  app.enableCors({
    origin: ['https://www.colegioandeschile.cl', 'https://www.intranet.colegioandeschile.cl', 'http://localhost', 'http://localhost:8200', 'http://localhost:8100', 'http://localhost:4200', 'http://localhost:8101', '*'],
